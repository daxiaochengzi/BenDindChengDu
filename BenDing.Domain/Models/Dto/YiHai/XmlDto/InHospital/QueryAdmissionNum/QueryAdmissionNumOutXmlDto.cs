...
namespace BenDing.Domain.Models.Dto.YiHai.XmlDto.InHospital.QueryAdmissionNum
{
    ...
    public class QueryAdmissionNumOutXmlDto
    {
        ...
        /// </summary>
        [XmlElement("ykd099")]
        public string QuasiBirthInformation { get; set; }

        /// <summary>
        /// 準生证签发地
        /// </summary>
        [XmlElement("ykd101")]
        public string BirthPermitIssueAt { get; set; }
        ...
        /// </summary>
        [XmlElement("ykd105")]
        public int GestationalAgeInformation { get; set; }

        /// <summary>
        /// 并发症标志
        /// </summary>
        [XmlElement("ykd106")]
        public string ComplicationMarker { get; set; }
