...
namespace BenDing.Domain.Models.Dto.YiHai.XmlDto.OpSpecials
{
    ...
    public class UpdateJobInjuryApplyInputDto
    {   /// <summary>
        /// 诊断信息
        /// </summary>
        [XmlElementAttribute("yke034")]
        ...
        [XmlArrayItem("row")]
        public List<UpdateJobInjuryApplyInputDetail> Details { get; set; }
    }
    /// <summary>
    /// 费用明细
    /// </summary>
    [XmlType(AnonymousType = true)]
    public class UpdateJobInjuryApplyInputDetail
    {
