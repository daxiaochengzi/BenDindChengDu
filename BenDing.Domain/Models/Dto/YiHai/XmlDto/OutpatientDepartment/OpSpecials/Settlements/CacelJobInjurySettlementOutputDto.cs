...
{   /// <summary>
    ...
    public class CacelJobInjurySettlementOutputDto
    {
        /// <summary>
        /// 就诊编码
        /// </summary>
        ...
        [XmlArrayItem("row")]
        public List<CancelSettlementDetail> CancelSettlementDetails { get; set; }

        /// <summary>
        /// 取消结算明细
        /// </summary>
        [XmlArrayAttribute("datasethospital")]
        [XmlArrayItem("row")]
        public List<CancelSettlementHospitalDetail> CancelSettlementHospitalDetails { get; set; }
    }


    public class CancelSettlementHospitalDetail
    {
        /// <summary>
        /// 参保中心
        /// </summary>
    ...
    public class CancelSettlementDetail
    {
        /// <summary>
        /// 参保中心
        /// </summary>
